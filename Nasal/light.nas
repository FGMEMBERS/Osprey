...
setlistener("/sim/model/lights/sbc2/state", func(n) {
  ...
  var beacon_enabled = bsbc1 and bsbc2 and getprop("/controls/lighting/beacon");
  setprop("/sim/model/lights/beacon/enabled", beacon_enabled);

  var strobe_enabled = bsbc1 and !bsbc2 and getprop("/controls/lighting/strobe");
  setprop("/sim/model/lights/strobe/enabled", strobe_enabled);
});
